...
namespace Team8_ADProjectLUStationerySystem.Models
{
    public class disbursement
    {
        ...
        private List<Models.disbursementdetails> details;
        ...
        public disbursement(string departmentName, string repPhoto, string repName, string collectionDes, string collectionDate, List<Models.disbursementdetails> details)
        {

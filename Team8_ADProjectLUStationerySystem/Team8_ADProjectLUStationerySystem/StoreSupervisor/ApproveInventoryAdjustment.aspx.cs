...
{
    public partial class ApproveInventoryAdjustment : System.Web.UI.Page
    {
        ...
        protected void LoadAllAdjustment()
        {
            ...
            {
                gdvAdjustment.DataSource = adglogic.LoadAllAdjust(userid);
                gdvAdjustment.DataBind();
        ...
        public String MyNewRow(object adjustmentId)
        {
            /* 

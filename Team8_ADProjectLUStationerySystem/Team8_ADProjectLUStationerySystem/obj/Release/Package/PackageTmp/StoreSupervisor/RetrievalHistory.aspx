<%@ Page Title="" Language="C#" MasterPageFile="~/StoreSupervisorMaster.Master" AutoEventWireup="true" CodeFile="RetrievalHistory.aspx.cs" Inherits="Team8_ADProjectLUStationerySystem.StoreSupervisor.RetrievalHistory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Text="No Record!" Visible="False" style="font-size:20px"></asp:Label></td></tr></table>

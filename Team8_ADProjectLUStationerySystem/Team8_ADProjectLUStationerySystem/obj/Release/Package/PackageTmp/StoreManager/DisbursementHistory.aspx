<%@ Page Title="" Language="C#" MasterPageFile="~/StoreManagerMaster.Master" AutoEventWireup="true" CodeBehind="DisbursementHistory.aspx.cs" Inherits="Team8_ADProjectLUStationerySystem.StoreManager.DisbursementHistory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width:85%; margin-left:10%; text-align:left; height: 231px;">
        ...
        </table>  <table style="width:85%; margin-left:10%; text-align:left; height: 100px;">
        <tr>
            <td>

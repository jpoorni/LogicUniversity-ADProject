<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMaster.Master" AutoEventWireup="true" CodeBehind="RequisitionHistory.aspx.cs" Inherits="Team8_ADProjectLUStationerySystem.Employee.RequisitionHistory" %>
                ...
                <asp:GridView ID="DisbursementListGridView" runat="server" CssClass="mGrid" style="font-size:20px" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="DisbursementListGridView_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">Re-Order</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>

<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMaster.Master" AutoEventWireup="true" CodeFile="DisbursementHistory.aspx.cs" Inherits="Team8_ADProjectLUStationerySystem.Employee.DisbursementHistory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width:85%; margin-left:10%; text-align:left; height: 231px;">
        ...
        <tr>
            ...
            <td class="modal-sm" style="width: 543px">
                <asp:TextBox ID="DateToTb" runat="server" CssClass="tb1" style="font-size:20px" TextMode="Date" OnTextChanged="DateToTb_TextChanged" AutoPostBack="True"></asp:TextBox>
            </td>
            <td></td>
        </tr>
        <tr>

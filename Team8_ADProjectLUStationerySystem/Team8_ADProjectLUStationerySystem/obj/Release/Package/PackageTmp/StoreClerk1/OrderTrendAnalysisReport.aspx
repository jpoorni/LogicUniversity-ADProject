<%@ Page Title="" Language="C#" MasterPageFile="~/StoreClerk.Master" AutoEventWireup="true" CodeFile="OrderTrendAnalysisReport.aspx.cs" Inherits="Team8_ADProjectLUStationerySystem.StoreClerk1.OrderTrendAnalysisReport" %>
...
.child {
    ...
    <div id="detailsView" visible="true" runat="server" style="width:78%; margin-left:10%; float:left; display: inline-block;background-color: #d3d3d3;border-radius:12px;height:140px; ">
        <table style="width:146px; margin-left:8%; text-align:left; height:100px;">
            <tr align ="center"><td> <div id ="parent">
        
            
                       
                            <asp:RadioButtonList ID="rdoyear1" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" style="font-size:20px" Width="113px"/></div>  </td></tr><tr align ="center"><td><div id="child">

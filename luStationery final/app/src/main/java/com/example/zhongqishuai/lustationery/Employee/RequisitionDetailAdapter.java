 ...
 */
public class RequisitionDetailAdapter extends BaseExpandableListAdapter {
    ...
    public RequisitionDetailAdapter(Context context, List<Requisition> requistions) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater inf = (LayoutInflater) context
                    .getSystemService(context.LAYOUT_INFLATER_SERVICE);
            convertView = inf.inflate(R.layout.requisition_detail_group, null);
        }
...
//                Log.i("dddddddddddddddd",Integer.toString(params[0]));
        ...
        TotalQty = (TextView)convertView.findViewById(R.id.reqTotalQty);
        TotalQty.setText(requisitionGroups.get(groupPosition).get("TotalQty").toString());
